...
export default class borrowEther extends Component{
    async componentDidMount(dispatch) {
        ...
        try {
            ...
            let Avaliable = (UserSupply['Collateral'] / etherPool['price'])/10**18 ;
    ...
    async borrowEther(){
        try {
            await this.state.iuhBank.methods.borrowingEth(this.state.amount).send({from: this.state.account});
            this.handleNextTab();
        } catch (error) {
            console.log(error)
        }
                ...
                <div>
                        <div className="deposit">
                            ...
                            <div className="text-center mt-5">
                                ...
                                <form>
                                    <Form.Label htmlFor="disabledTextInput">Avaliable to borrow: {this.state.Avaliable != null && (this.state.Avaliable).toLocaleString()} Ether</Form.Label>
                    ...
                    <div>
                        <div className="deposit">
                            ...
                            <div className="text-center mt-5">
                                ...
                                <form>
                                    <Form.Label htmlFor="disabledTextInput">Amount to borrow {this.state.amount} Ether</Form.Label>
                                </form>
